class Grid {
    constructor(radius = 4) {
        ...
        this.firstDirection = this.directions[4];
        for (let radiusIndex = 0, radiusCellsQuantity = 1;
            ...
            for (let radiusCellsIndex = 0, directionIndex = 0;
                ...
                radiusCellsIndex++, radiusCellsIndex != 1 && radiusCellsIndex % radiusIndex == 0 ? directionIndex++ : directionIndex) { //!
                ...
                if (radiusCellsIndex == 0) {
                    this.cells.push(new Cell(radiusIndex * this.firstDirection.x, radiusIndex * this.firstDirection.y, radiusIndex * this.firstDirection.z));
                    console.log(`${radiusIndex * this.firstDirection.x}, ${radiusIndex * this.firstDirection.y}, ${radiusIndex * this.firstDirection.z}`);
                } else {
